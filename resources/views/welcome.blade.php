   ...
   <body>
      ...
      <div class="banner_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <div class="banner_taital">BOOK <br>Hiệu sách của Nàng</div>
            ...
            <div class="row">
               ...
               <div class="col-sm-8 col-lg-4">
                  ...
                  <div class="movie_main">
                     ...
                     <div class="mins_text"><img src="frontend/images/icon-1.png"><span class="icon_1">Watchlist</span></div>
                  </div>
                  ...
                  <div class="rating_main">
                     <div class="row">
                        <div class="col-sm-6 col-lg-6">
                           <div class="icon_2"><img src="frontend/images/icon-2.png"><span class="padding_10">4.6 Revieweed</span></div>
                        </div>
                        <div class="col-sm-6 col-lg-6">
                           <div class="icon_2"><img src="frontend/images/icon-2.png"><span class="padding_10">Your Rateing</span></div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="box_main">
               ...
               <div class="mail_main">
                  ...
                  <div class="right_arrow">
                     <a href="#"><img src="frontend/images/right-arrow.png"></a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="cooming_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <div class="image_17">
                     <div class="image_17"><img src="frontend/images/img-17.png"></div>
                  </div>
               </div>
               <div class="col-md-6">
         ...
         <div class="container">
            <div class="footer_menu">
               <ul>
                  ...
                  <li><a href="movies.html">Sách</a></li>
                  <li><a href="tv.html">Truyện</a></li>
                  <li><a href="celebs.html">Đồ dùng</a></li>
                  <!-- <li><a href="#">Sports</a></li>
                  <li><a href="#">News</a></li> -->
               </ul>
            </div>
